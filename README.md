...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/textstat-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9045&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/textstat-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `textstat` can be installed with:

```
conda install textstat
```

It is possible to list all of the versions of `textstat` available on your platform with:
